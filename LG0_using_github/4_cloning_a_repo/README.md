...
3. Inside the game assets sub-folder, copy and paste in all of the png images from step 6 above (the bullet, hero, monster, explosion, and cracked ground image). You need to copy/paste in these files to your own personal repo, as you cannot make file changes on the MrPrattASH repo. (You can change this repo on your local computer, but it won't change on remote, because it is MrPrattASH's repo, not your repo). Later on in the course you will need to copy more content from this repo, and I suggest you copy/paste that content again, rather that re-writing the local file paths. 
